...
function Login() {
    return (
        <>
            {/* < MDBContainer fluid className='align-items-center flex justify-center' >

                <MDBRow className='g-0 w-3/4 align-items-center'>
                    <MDBCol col='6'>
                    ...
                    <MDBCol col='6'>
                        <svg className='w-11/12 ml-4' xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" width="869.99994" height="520.13854"
                            viewBox="0 0 869.99994 520.13854" xmlns="http://www.w3.org/1999/xlink">
