...
export const createExam = createAsyncThunk(
  ...
  async (data, { rejectWithValue }) => {
    const response = await fetch(
      "https://myndkare-backend.onrender.com/myndkare/v1/exams",
      {
        method: "POST",
        headers: {
...
export const showMBTIExam = createAsyncThunk(
  ...
  async (args, { rejectWithValue }) => {
    const response = await fetch(
      "https://myndkare-backend.onrender.com/myndkare/v1/exams/mbti",
      { method: "GET" }
    );
...
export const getExamsCount = createAsyncThunk(
  ...
  async (args, { rejectWithValue }) => {
    const response = await fetch(
      "https://myndkare-backend.onrender.com/myndkare/v1/examsCount",
      { method: "GET" }
    );
...
export const deleteExam = createAsyncThunk(
  ...
  async (id, { rejectWithValue }) => {
    const response = await fetch(
      `https://myndkare-backend.onrender.com/myndkare/v1/exams/${id}`,
      { method: "DELETE" }
    );
